...
public class SellerFormController implements Initializable {
	...
	// Pegar os dados do formulário da view
	...
	// Pega os dados do vendedor e colocar na caixa de texto da view de atualização
	...
	// Carregar os departamentos para uma lista para jogar no combobox de atualização do vendedor
	...
	private void initializeNodes() {
		Constraints.setTextFieldInteger(txtId); // Apenas números inteiro
